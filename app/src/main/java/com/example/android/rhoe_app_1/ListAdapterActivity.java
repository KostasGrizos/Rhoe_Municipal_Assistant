...
public class ListAdapterActivity extends BaseAdapter implements ListAdapter {
    private ArrayList<String> list = new ArrayList<>();
    private ArrayList<String> list1 = new ArrayList<>();
    private ArrayList<String> listKey = new ArrayList<>();
    private Context context;
    FineListActivity fineListActivity;
    ...
    public ListAdapterActivity(ArrayList<String> list, ArrayList<String> list1, ArrayList<String> listKey, Context context) {
        this.list = list;
        this.list1 = list1;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView LicencePlateTextView = (TextView)view.findViewById(R.id.tvLicencePlateLA);
        LicencePlateTextView.setText(list.get(position));
        TextView DateTextView = (TextView)view.findViewById(R.id.tvDateLA);
        DateTextView.setText(list1.get(position));

        //Handle buttons and add onClickListeners
        ImageButton InfoButton = (ImageButton)view.findViewById(R.id.btnInfoLA);
        ImageButton PrintButton = (ImageButton)view.findViewById(R.id.btnPrintLA);
        ImageButton PayButton = (ImageButton)view.findViewById(R.id.btnPayLA);
                    ...
                    public void onDataChange(DataSnapshot UdataSnapshot) {
                        ...
                        mRefClick.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                builder.setTitle("Βεβαίωση Παράβασης Κ.Ο.Κ.");
                                builder.setCancelable(false);
                                builder.setMessage(Html.fromHtml("<b>Ημερομηνία/Ώρα</b> <br>" + DateReprint + " " +TimeReprint + "<br>" +
                                ...
                                builder.setPositiveButton("ΟΚ", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        //FineListActivity.populateListView(plate, munB, paidB, unpaidB);
                                        dialog.cancel();
                                    }
                                });
                                builder.create();
