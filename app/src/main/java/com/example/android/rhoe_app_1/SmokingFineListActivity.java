...
import com.example.android.rhoe_app_1.FirebaseFine.RetrieveSmokingFineInfoFirebase;
...
public class SmokingFineListActivity extends AppCompatActivity {

    private static final String TAG = "SmokingFineListActivity";
    ...
    private String IdReprint, NameReprint, DateReprint, DayReprint, TimeReprint, AddressReprint, FineAmountReprint, TfnReprint, FineTypeReprint, DoyReprint, PaidReprint, CategoryReprint;
    @Override
                ...
                mRefClick.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (Objects.equals(PaidReprint, "No")){
                            showFineDetails(SmokingFineListActivity.this);
                        }
                    }
                    @Override
                        ...
                        databaseReference.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                while (items.hasNext()) {
                                    ...
                                    String RealNameSur = item.child("Name").getValue().toString();
    ...
    */
    ...
    private String MunFine() {
        ...
        String fine = tmpFine1 + tmpFine3 + tmpFine4 + tmpFine5 + tmpFine6 + tmpFine7 + tmpFine8 + tmpFine9 + tmpFine10;
        return fine;
    }
    ...
    private void showDataFromUser (DataSnapshot dataSnapshot) {
        for (DataSnapshot ds : dataSnapshot.getChildren()){
            ...
            MID = RUInfo.getMID();
            databaseReference = FirebaseDatabase.getInstance().getReference("Fines").child(MID).child("SmokingFines");
    ...
    private void showDataFromFine (DataSnapshot dataSnapshot) {
        for (DataSnapshot ds : dataSnapshot.getChildren()){
            RetrieveSmokingFineInfoFirebase RInfo = new RetrieveSmokingFineInfoFirebase();
            RInfo.setAddress(dataSnapshot.getValue(RetrieveSmokingFineInfoFirebase.class).getAddress());
            RInfo.setDoy(dataSnapshot.getValue(RetrieveSmokingFineInfoFirebase.class).getDoy());
            RInfo.setName(dataSnapshot.getValue(RetrieveSmokingFineInfoFirebase.class).getName());
            RInfo.setTfn(dataSnapshot.getValue(RetrieveSmokingFineInfoFirebase.class).getTfn());
            RInfo.setId(dataSnapshot.getValue(RetrieveSmokingFineInfoFirebase.class).getId());
            RInfo.setDate(dataSnapshot.getValue(RetrieveSmokingFineInfoFirebase.class).getDate());
            RInfo.setDay(dataSnapshot.getValue(RetrieveSmokingFineInfoFirebase.class).getDay());
            RInfo.setFineAmount(dataSnapshot.getValue(RetrieveSmokingFineInfoFirebase.class).getFineAmount());
            RInfo.setFineType(dataSnapshot.getValue(RetrieveSmokingFineInfoFirebase.class).getFineType());
            RInfo.setTime(dataSnapshot.getValue(RetrieveSmokingFineInfoFirebase.class).getTime());
            RInfo.setUserID(dataSnapshot.getValue(RetrieveSmokingFineInfoFirebase.class).getUserID());
            RInfo.setPaid(dataSnapshot.getValue(RetrieveSmokingFineInfoFirebase.class).getPaid());
            RInfo.setLat(dataSnapshot.getValue(RetrieveSmokingFineInfoFirebase.class).getLat());
            RInfo.setLon(dataSnapshot.getValue(RetrieveSmokingFineInfoFirebase.class).getLon());
            RInfo.setCategory(dataSnapshot.getValue(RetrieveSmokingFineInfoFirebase.class).getCategory());

            AddressReprint = RInfo.getAddress();
            DoyReprint = RInfo.getDoy();
            NameReprint = RInfo.getName();
            TfnReprint = RInfo.getTfn();
            IdReprint = RInfo.getId();
            ...
            CategoryReprint = RInfo.getCategory();
        }
    }
